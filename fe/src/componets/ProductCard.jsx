  ...
  return (
    ...
    >
      <div className="relative">
        <img src={item.image} width={200} className="m-auto object-cover" alt={item.name} />
        {isHovered && (
          <button
            className="absolute bottom-18 left-1/2 transform -translate-x-1/2 bg-white text-black py-2 my-3 px-4 rounded-full shadow-lg"
          >
            Add to cart
          </button>
        )}
